defmodule StreaksWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StreaksWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StreaksWeb.Gettext, "errors", msg, opts)
    end
  end
